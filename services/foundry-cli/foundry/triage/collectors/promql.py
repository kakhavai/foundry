...
These target the OpenTelemetry FastAPI instrumentation exported via
PrometheusMetricReader. The eval harness (a later task) confirms the exact series names
against live Prometheus and edits these constants if needed."""
