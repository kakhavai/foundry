...
Services are responsible for initializing the OTel SDK and instrumenting their framework. See `services/weather/weather/telemetry.py` for the reference implementation.
